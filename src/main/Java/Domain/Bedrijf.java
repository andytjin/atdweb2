 ...
 * Aangepast voor ThemaOpdracht 4 door: Max Raadgever
 */
package Domain;
...
public class Bedrijf implements Serializable {
    ...
    private void aanmaken() { //hierin worden alle arraylists vast gevuld met wat testobjecten
        ...
        alleArtikelen.add(a1);
        alleArtikelen.add(a2);
        alleArtikelen.add(a3);
        alleArtikelen.add(a4);
        alleArtikelen.add(a5);
        alleArtikelen.add(a6);
        alleArtikelen.add(a7);
        alleArtikelen.add(a8);
        ...
        Klant k1 = new Klant("Thijsie", "Thijs Gelton", "a", "Nijenoord 1", "06-06-1996", "0612345678", "4105EE", "thijs.gelton@student.hu.nl", true);
        Klant k2 = new Klant("Sam123", "Sam Cornelissen", "a", "Oudenoord 500", "06-06-1996", "0687654321", "5083FF", "sam.cornellisen@student.hu.nl", true);
        alleKlanten.add(k1);
        alleKlanten.add(k2);
        ...
        Dienst d1 = new Onderhoudsbeurt(1, "03-04-2012", aut1, m1);
        d1.setDeBetaling(f1);
        Dienst d2 = new Onderhoudsbeurt(2, "03-04-2015", aut2, m2);
        d2.setDeBetaling(f2);
        Dienst d7 = new Onderhoudsbeurt(7, "23-04-2017", aut1, m1);
        d7.setDeBetaling(f3);
        Dienst d8 = new Onderhoudsbeurt(8, "03-07-2015", aut2, m2);
        d8.setDeBetaling(f4);
        Dienst d9 = new Onderhoudsbeurt(9, "23-04-2017", aut1, m1);
        d9.setDeBetaling(f5);
        Dienst d3 = new ParkeerDienst(3, "03-04-2012", 20);
        d3.setDeBetaling(f6);
        Dienst d4 = new ParkeerDienst(4, "03-04-2015", 500);
        d4.setDeBetaling(f7);
        Dienst d5 = new TankDienst(5, "03-04-2012", a9, 10);
        d5.setDeBetaling(f8);
        Dienst d6 = new TankDienst(6, "03-04-2015", a10, 50);
        d6.setDeBetaling(f9);
        alleDiensten.add(d1);
        alleDiensten.add(d2);
        alleDiensten.add(d3);
